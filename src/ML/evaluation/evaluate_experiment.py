...
if len(sys.argv) != 2:
    raise ValueError(
        "Usage: python -m src.ML.evaluation.evaluate_experiment <experiment_name>"
    )
...
GROUND_TRUTH_FILE = (
    f"DATA_ML/experiments/{experiment_name}/ground_truth.csv"
)

OUTPUT_FILE = (
    f"DATA_ML/experiments/{experiment_name}/evaluation_results.csv"
)
